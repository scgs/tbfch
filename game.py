...
def place_objects(room):
    ...
    monster_chances = {}
    monster_chances['cockroach'] = 80  #orc always shows up, even if all other monsters have 0 chance
    monster_chances['centipede'] = from_dungeon_level([[15, 3], [30, 5], [60, 7]])
    ...
    for i in range(num_monsters):
        ...
        if not is_blocked(x, y):
            ...
            if choice == 'cockroach':
                ...
                monster = Object(x, y, 'c', 'cockroach', libtcod.desaturated_green,
                    blocks=True, fighter=fighter_component, ai=ai_component)
 
            elif choice == 'centipede':
                #create a centipede
                fighter_component = Fighter(hp=30, defense=2, power=8, xp=100, death_function=monster_death)
                ai_component = BasicMonster()
 
                monster = Object(x, y, 'H', 'house centipede', libtcod.darker_green,
                    blocks=True, fighter=fighter_component, ai=ai_component)
...
def render_all():
    ...
    libtcod.console_print_left(panel, 1, 3, libtcod.BKGND_NONE, 'Cuyler level ' + str(dungeon_level))
...
def check_level_up():
    ...
    if player.fighter.xp >= level_up_xp:
        ...
        message('Your insect-killing skills grow stronger! You reached level ' + str(player.level) + '!', libtcod.yellow)
...
def new_game():
    ...
    message('Welcome stranger! Prepare to die to the roach infestation in Cuyler.', libtcod.red)
...
def next_level():
    ...
    dungeon_level += 1
    message('After a rare moment of peace, you ascend higher into the heart of the infestation...', libtcod.red)
...
def main_menu():
    while not libtcod.console_is_window_closed():
        ...
        libtcod.console_print_center(0, SCREEN_WIDTH/2, SCREEN_HEIGHT/2-4, libtcod.BKGND_NONE, 'The Battle For Cuyler Hall')
